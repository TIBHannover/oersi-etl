...
service_domain = "phaidra.fh-salzburg.ac.at";
service_id = "https://phaidra.fh-salzburg.ac.at/";
service_name = "Phaidra FH Salzburg";
XML_FILE = FLUX_DIR + "phaidraFHSalzburg-metafacture.xml";

"https://phaidra.fh-salzburg.ac.at/api/oai"
...
| decode-xml
| handle-generic-xml(emitNamespace="true")
| fix(FLUX_DIR + "phaidraFHSalzburg.fix",*)
| encode-json
