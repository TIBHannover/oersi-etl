...
service_domain = "door.donau-uni.ac.at";
service_id = "https://door.donau-uni.ac.at/";
service_name = "Phaidra Universität für Weiterbildung Krems";
...
| decode-xml
| handle-generic-xml(emitNamespace="true")
| fix(FLUX_DIR + "phaidraDonauUniKrems.fix",*)
| encode-json
