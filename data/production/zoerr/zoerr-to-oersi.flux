...
| oersi.JsonApiReader(header=user_agent_header, method="post", body="{\"resolveCollections\": false, \"criterias\": [], \"facettes\": []}", recordPath="nodes", pageParam="skipCount", stepSize="10", totalLimit=input_limit)
| decode-json
| filter-null-values
