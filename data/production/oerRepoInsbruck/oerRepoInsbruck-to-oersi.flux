service_domain="https://oer-repo.uibk.ac.at/edu-sharing/";
...
"https://oer-repo.uibk.ac.at/edu-sharing/rest/search/v1/queriesV2/-home-/-default-/ngsearch?maxItems=10&skipCount=0&propertyFilter=-all-"
...
| fix(FLUX_DIR + "oerRepoInsbruck_edu-sharing.fix", *) // '*': pass all flux variables to the fix
| encode-json
