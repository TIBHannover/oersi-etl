...
"[EDUSHARING-PROVIDER-URL]/edu-sharing/rest/search/v1/queries/-home-/-default-/ngsearch?maxItems=10&skipCount=0&propertyFilter=-all-"
...
| fix(FLUX_DIR + "template_edu-sharing.fix", *) // '*': pass all flux variables to the fix
| encode-json
