...
public class IndexerTestSiteMap {
    ...
    public static Collection<Object[]> siteMaps() {
        return Arrays.asList(new Object[][] { //
                { "https://www.hoou.de/sitemap.xml", "https://www.hoou.de/materials/",
                        Arrays.asList( // -->
                ...
                { "https://www.oncampus.de/sitemap.xml", "https://www.oncampus.de/",
                        Arrays.asList( // -->
    ...
    @Test
    public void testConvertSitemap() throws IOException, RecognitionException, SAXException {
        ...
        urls.forEach(url -> {
            assertThat(resultUrls, hasItem(url));
        });
    }
}
